...
public class MemberService {
    ...
    private void authenticate(String email, String pwd) {
        try {
            ...
            throw new MemberException("Account is disabled.", HttpStatus.BAD_REQUEST);
    ...
    private void checkPassword(String password, String passwordCheck) {
        if (!password.equals(passwordCheck)) {
            throw new MemberException("Passwords do not match.", HttpStatus.BAD_REQUEST);
        }
    }
    ...
    private void checkEncodePassword(String rawPassword, String encodedPassword) {
        if (!encoder.matches(rawPassword, encodedPassword)) {
            throw new MemberException("Invalid password.", HttpStatus.BAD_REQUEST);
        }
    }
}
